...
const SizeInfo = ({ storeId, id }: { storeId: string; id: string }) => {
  const { data: size, isLoading, error } = useGetSize(storeId, id);
  ...
  if (isLoading) {
    return (
      <div className="p-6 flex items-center justify-center">
        ...
        <span className="ml-3 text-gray-600">Loading size...</span>
      </div>
    );
  }
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2 flex justify-between items-center">
          ...
          <p>
            <Link
              href={`/store/${storeId}/size/${id}/edit`}
            ...
            <div>
              <DeleteBtn sizeId={id} storeId={storeId} />
            </div>
        </h1>

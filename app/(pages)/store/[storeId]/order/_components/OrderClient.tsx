...
const createColumns = (): ColumnDef<Order>[] => [
  {
    ...
    header: "Email",
    cell: ({ row }) => (
      <div className="font-medium">{row.getValue("customerEmail")}</div>
    ),
  },
  {
    accessorKey: "phone",
    header: "Phone",
    cell: ({ row }) => (
      <div className={`h-18 w-18`}>{row.getValue("phone")}</div>
    ),
  },
  {
    accessorKey: "address",
    header: "Address",
    cell: ({ row }) => (
      <div className={`h-18 w-18`}>{row.getValue("address")}</div>
    ),
  },
  {
    accessorKey: "isPaid",

      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-2xl font-bold">Billboards API</h1>
          </div>
          <p className="text-gray-600">
            API endpoints for managing billboards. Replace placeholders with
            actual IDs.
          </p>
        </div>
        ...
        <div className="">
          ...
          <div className="lg:col-span-2">
            <div className=" border p-6 mb-6">
              <h2 className="text-lg font-semibold mb-4">Billboards</h2>
              <BillboardClient />
            </div>
          </div>
            ...
            <div className=" rounded-lg border p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <APIAlert
                    description={`${domin}/api/${storeId}/billboard`}
                    title="GET"
                    variant="public"
                  />
                </div>
                ...
                <div>
                  ...
                  <APIAlert
                    description={`${domin}/api/${storeId}/billboard/[id]`}
                    title="GET"
                    variant="public"
                  />
                </div>
